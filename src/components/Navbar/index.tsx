...
const sections = ["Movies", "TV Shows", "People"];
...
export const Navbar = (): React.ReactElement => (
  <header className="absolute w-full">
    <div className="container mx-auto flex p-5 flex-row items-center justify-between">
      <a
        href="/"
        className="flex font-black tracking-widest items-center text-xl"
      >
        RMDB
      </a>
      ...
      <MenuIcon className="fill-current cursor-pointer md:hidden" />
